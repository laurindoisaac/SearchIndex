...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SearchIndex processing");
    
    let mut processor = SearchIndexProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SearchIndexProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SearchIndexProcessor::new(false);
